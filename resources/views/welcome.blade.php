...
<body class="bg-[060522]">
    ...
    <div id="waves"
        class=" h-[78vh] mt-10 overflow-hidden bg-[#061434] shadow-lg shadow-darkBlue-900/20 mx-32 rounded-3xl grid grid-rows-[90%_10%]">
        <div class="grid grid-cols-[40%_60%] p-10">
            <div>
                <img class="mx-auto rounded-[120px] h-[400px] w-[400px] object-scale-down" src="images/me.jpg"
                    alt="">
                <p class="text-center text-white font-bold font-mono text-3xl m-2 mt-6 ">📍Amsterdam</p>
                <p class="text-center text-white font-mono font-bold text-3xl m-2"><strong
                        class="text-[#13B9B9]">{{$age}}</strong> Years old of age</p>
            </div>
            <div>
                <pre class=' text-center text-white font-black text-2xl'
...
|____/|_|_|\__,_|_| |_|\_\___|_|  |_|\_\___|_| |_|_|
                ...
                <div class="mx-auto text-center max-w-[90%] 2xl:text-lg text-white font-bold mt-4 font-mono">
                    <p class="mt-10">Hi! I'm Bilal, a software developer and student deeply interested in the
                        compute industry,
                        particularly as it evolves alongside AI infrastructure. The rise of AI is reshaping our world,
                        demanding substantial computing power for its development and upkeep. While traditional
                        companies grapple with the shift from low-powered servers to high-performance supercomputers, I
                        see an opportunity to drive innovation and shape the future of this industry.
                    </p>
                    <p class="mt-4">Currently, I'm actively involved in software development. Whether you have a
                        project or a business idea, I'm eager to explore opportunities where I can contribute and
                        collaborate. Let's connect and discuss how we can innovate!</p>
                </div>
            </div>
        </div>
        <div class="text-white text-xl font-bold text-center grid grid-cols-[20%_20%_60%] font-mono ">
            <a href="https://github.com/r5q0" class="text-center items-center flex mx-auto mb-20 text-2xl">
                <svg class="h-10 w-10 " viewBox="0 0 98 96"xmlns="http://www.w3.org/2000/svg">
                ...
                <a class="text-center items-center flex mx-auto mb-20 text-2xl" href="https://www.linkedin.com/in/bilal-user/">
                    <svg class="inline-block h-9 w-9" viewBox="0 0 16 16" fill="none"
    ...
    <div class="mx-32 grid grid-cols-[35%_65%] ">
