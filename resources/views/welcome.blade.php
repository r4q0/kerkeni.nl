...
<body class="bg-[060522]">
    ...
    <div id="waves" class="h-[110vh] md:h-[72vh] md:m-5 md:mt-10 bg-[#061434] shadow-lg shadow-darkBlue-900/20 md:mx-40 rounded-3xl grid grid-cols md:grid-rows-[90%_10%]">
        <div class="grid grid-rows md:grid-cols-[40%_60%] p-2 md:p-10">
            <div>
                <img class="md:mx-auto rounded-[120px] h-[80vw] w-[80vw] object-scale-down" src="images/me.jpg"
                    alt="">
            ...
            <div class="grid grid-rows-[20%_80%]">
                <pre class='text-center text-white font-black text-sm md:text-2xl'
...
|____/|_|_|\__,_|_| |_|\_\___|_|  |_|\_\___|_| |_|_|
                ...
                <div class="mx-auto text-center max-w-[75%] text-sm md:text-lg text-white font-bold mt-4 font-mono grid place-items-center">
