...
<body class="bg-[060522]">
    ...
    <div id="waves" class=" h-[72vh] mt-10 bg-[#061434] shadow-lg shadow-darkBlue-900/20 mx-40 rounded-3xl grid grid-rows-[90%_10%]">
        <div class="grid grid-cols-[40%_60%] p-10">
            <div>
                <img class="mx-auto rounded-[120px] h-[400px] w-[400px] object-scale-down" src="images/me.jpg"
                    alt="">
                <p class="text-center text-white font-bold font-mono text-3xl m-2">📍Amsterdam</p>
            ...
            <div class="grid grid-rows-[20%_80%]">
                <pre class='text-center text-white font-black lg:text-2xl'
...
|____/|_|_|\__,_|_| |_|\_\___|_|  |_|\_\___|_| |_|_|
                ...
                <div class="mx-auto text-center max-w-[75%] 2xl:text-lg text-white font-bold mt-4 font-mono grid place-items-center">
        ...
        <div class="text-white text-xl font-bold text-center grid grid-cols-[20%_20%_60%] font-mono ">
            <a href="https://github.com/r4q0" class="text-center items-center flex mx-auto text-2xl">
            ...
            <a class="text-center items-center flex mx-auto text-2xl"
            ...
            <div class="text-[#63B3ED] text-center items-center flex mx-auto text-2xl underline">
