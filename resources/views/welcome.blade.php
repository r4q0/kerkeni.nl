    ...
    <div id="waves"
        ...
        <div class="grid grid-cols-[40%_60%] p-10">
            <div>
                ...
                <p class="text-center text-white font-mono font-bold text-3xl m-2">I'm <strong
...
|____/|_|_|\__,_|_| |_|\_\___|_|  |_|\_\___|_| |_|_|
        ...
        <div class="text-white text-xl font-bold text-center grid grid-cols-[20%_20%_60%] font-mono ">
            <a href="https://github.com/r4q0" class="text-center items-center flex mx-auto mb-20 text-2xl">
