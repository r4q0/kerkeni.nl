    ...
    <div class="flex justify-center items-center">
        <div class="grid grid-cols-1 w-[100vw] md:w-[60vw] ">
            ...
            @foreach ($projects as $project)
                <div class="bg-[#061434] border-2 border-white text-white md:h-52 m-5 p-4 rounded-lg grid grid-rows-[23%_77%]">
                    <div class="grid grid-rows md:grid-cols-[60%_40%]">
                        ...
                        <a class="mx-auto inline-flex items-center font-bold font-mono text-center text-2xl my-auto " href="{{$project['url']}}">  
                            <svg class="mt-5 md:mt-0 h-9 w-9 flex p-1 m-0 " viewBox="0 0 98 96"xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                ...
                                fill="white" />
                        </svg> <p class="mt-5 md:mt-0 md:m-0 p-0">Repository</p></a>
                    </div>
                    <div class="grid grid-rows md:grid-cols-[60%_40%]">
                        <p class="my-auto mb-5 md:mb2 font-mono line-clamp-5 overflow-hidden m-2 text-center text-lg">{{ $project['description'] }}</p>
