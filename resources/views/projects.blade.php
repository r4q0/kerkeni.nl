...
<body class="bg-[#060522]">
    <a class="flex w-14 m-2" href="{{ route('home') }}">
        <svg class="flex h-12 w-14" fill="white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
            <path
                ...
                <div
                    ...
                    <div class="grid grid-cols-[60%_40%]">
                        ...
                        <a class="mx-auto inline-flex items-center font-bold font-mono text-center text-2xl my-auto " href="{{$project['url']}}">  
                            <svg class="h-9 w-9 flex p-1 m-0 " viewBox="0 0 98 96"xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                ...
                                fill="white" />
                        </svg> <p class="m-0 p-0">Repository</p></a>
                    </div>
                    <div class="grid grid-cols-[60%_40%]">
